...
<div class="max-w-4xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-gray-600 mt-1">添加新的商品到库存系统</p>
        </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <select id="type" 
                                        ...
                                        <option value="standard" {{ old('type') == 'standard' ? 'selected' : '' }}>基础商品</option>
                                        <option value="blind_bag" {{ old('type') == 'blind_bag' ? 'selected' : '' }}>盲袋商品</option>
                                    </select>
                                    @error('type')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                ...
                                <div>
                                    ...
                                    <textarea id="description" 
                                              ...
                                              placeholder="请输入商品描述">{{ old('description') }}</textarea>
                                    @error('description')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div>
                                    <label for="stock" class="block text-sm font-medium text-gray-700 mb-2">
                                        初始库存 <span class="text-red-500">*</span>
                                    </label>
                                    <input type="number" 
                                           id="stock" 
                                           name="stock" 
                                           ...
                                           min="0" 
                                           required
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors @error('stock') border-red-500 ring-2 ring-red-200 @enderror"
                                           placeholder="0">
                                    @error('stock')
                                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="space-y-4">
                                ...
                                <div class="mt-4">
                                    <img id="imagePreview" 
                                         src="#" 
                                         alt="预览图" 
                                         class="w-full h-48 object-cover rounded-lg border border-gray-200 hidden">
                                    <div id="imagePlaceholder" class="w-full h-48 bg-gray-100 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center">
                        ...
                        <div class="bg-gray-50 rounded-lg p-5">
                            ...
                            <p class="text-xs text-gray-500 mt-2">选中后商品将立即上架销售</p>
                        </div>
                    </div>
                </div>
            </div>
