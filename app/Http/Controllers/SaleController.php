...
class SaleController extends Controller
{
    ...
    public function edit(Sale $sale)
    {
        ...
        $priceSeries = \App\Models\PriceSeries::where('is_active', true)->orderBy('code')->get();
        $sale->load(['saleDetails', 'priceSeriesSaleDetails']);
        return view('sales.edit', compact('sale', 'products', 'priceSeries'));
    }
